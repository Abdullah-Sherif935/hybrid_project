    ...
    if (fabs(Rotary_Inverted_Pendulum_HIL__B.Switch) >
      ...
      Rotary_Inverted_Pendulum_HIL__B.ControlAction =
        (((-Rotary_Inverted_Pendulum_HIL__P.k[0] *
           ...
           -Rotary_Inverted_Pendulum_HIL__P.k[1] * rtb_Derivative) +
          -Rotary_Inverted_Pendulum_HIL__P.k[2] *
...
void Rotary_Inverted_Pendulum_HIL_Tutorial_initialize(void)
{
  ...
  Rotary_Inverted_Pendulum_HIL_M->Timing.stepSize0 = 0.1;

  /* External mode info */
  Rotary_Inverted_Pendulum_HIL_M->Sizes.checksums[0] = (931803962U);
  Rotary_Inverted_Pendulum_HIL_M->Sizes.checksums[1] = (2288905801U);
  Rotary_Inverted_Pendulum_HIL_M->Sizes.checksums[2] = (2055215163U);
  Rotary_Inverted_Pendulum_HIL_M->Sizes.checksums[3] = (2777321507U);
