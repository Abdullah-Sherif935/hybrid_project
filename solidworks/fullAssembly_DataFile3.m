...
%Translation Method - Cartesian
%Rotation Method - Arbitrary Axis
smiData.RigidTransform(8).translation = [6.2172489379008766e-14 -3.979039320256561e-13 79.000000000000327];  % mm
...
%Translation Method - Cartesian
%Rotation Method - Arbitrary Axis
smiData.RigidTransform(11).translation = [0 0 2.0000000000000018];  % mm
smiData.RigidTransform(11).angle = 0;  % rad
smiData.RigidTransform(11).axis = [0 0 0];
smiData.RigidTransform(11).ID = "B[Base cover-1:-:NTN_6000  (Bearing 10x26x8)-8]";

%Translation Method - Cartesian
%Rotation Method - Arbitrary Axis
smiData.RigidTransform(12).translation = [7.9999999999999707 2.6645352591003757e-15 -8.5750035165785557e-15];  % mm
...
smiData.RigidTransform(12).ID = "F[Base cover-1:-:NTN_6000  (Bearing 10x26x8)-8]";

%Translation Method - Cartesian
%Rotation Method - Arbitrary Axis
smiData.RigidTransform(13).translation = [0 0 8.9999999999999947];  % mm
smiData.RigidTransform(13).angle = 3.1415926535897931;  % rad
smiData.RigidTransform(13).axis = [1 0 0];
smiData.RigidTransform(13).ID = "B[cover of the bearing-1:-:NTN_6000  (Bearing 10x26x8)-8]";

%Translation Method - Cartesian
%Rotation Method - Arbitrary Axis
smiData.RigidTransform(14).translation = [-6.0000000000000275 0 -6.0032452383683477e-15];  % mm
...
smiData.RigidTransform(14).ID = "F[cover of the bearing-1:-:NTN_6000  (Bearing 10x26x8)-8]";
...
smiData.RigidTransform(15).ID = "B[cross holder of the motor-1:-:MH2530-6.35-10-1]";

%Translation Method - Cartesian
%Rotation Method - Arbitrary Axis
smiData.RigidTransform(16).translation = [-8.4376949871511897e-14 -9.5923269327613525e-14 30.399999999999675];  % mm
smiData.RigidTransform(16).angle = 3.1415926535897842;  % rad
smiData.RigidTransform(16).axis = [1 -7.0678690879950565e-31 -1.5728546641096343e-16];
smiData.RigidTransform(16).ID = "F[cross holder of the motor-1:-:MH2530-6.35-10-1]";

%Translation Method - Cartesian
%Rotation Method - Arbitrary Axis
smiData.RigidTransform(17).translation = [60.000000002849802 59.999999999999979 -26.000000000000004];  % mm
...
smiData.RigidTransform(17).ID = "B[holder of Encoder-1:-:second link holder-1]";

%Translation Method - Cartesian
%Rotation Method - Arbitrary Axis
smiData.RigidTransform(18).translation = [-25.999999999999979 -5.0000000000000053 5.0000000000000089];  % mm
smiData.RigidTransform(18).angle = 1.570796326794897;  % rad
smiData.RigidTransform(18).axis = [-1 -5.354727247988605e-17 -7.3234414932229394e-17];
smiData.RigidTransform(18).ID = "F[holder of Encoder-1:-:second link holder-1]";

%Translation Method - Cartesian
%Rotation Method - Arbitrary Axis
smiData.RigidTransform(19).translation = [0 24.000000000000021 -3.0000000000000027];  % mm
smiData.RigidTransform(19).angle = 0;  % rad
smiData.RigidTransform(19).axis = [0 0 0];
smiData.RigidTransform(19).ID = "B[second link holder-1:-:cover of the bearing-3]";

%Translation Method - Cartesian
%Rotation Method - Arbitrary Axis
smiData.RigidTransform(20).translation = [1.2494507439907402e-10 4.9047052129603698e-11 3.00000000015784];  % mm
smiData.RigidTransform(20).angle = 3.1415926535897931;  % rad
smiData.RigidTransform(20).axis = [-0.82631411725951476 0.56320953438096999 8.9970840357478773e-18];
smiData.RigidTransform(20).ID = "F[second link holder-1:-:cover of the bearing-3]";
...
smiData.RigidTransform(21).ID = "B[holder of Encoder-1:-:MH2530-6.35-10-1]";

%Translation Method - Cartesian
%Rotation Method - Arbitrary Axis
smiData.RigidTransform(22).translation = [-1.3988810110276972e-14 1.0658141036401503e-14 20.600000000000001];  % mm
smiData.RigidTransform(22).angle = 4.6614702184556537e-16;  % rad
smiData.RigidTransform(22).axis = [-0.69071685887283696 0.72312531477527542 -1.1641435597320696e-16];
smiData.RigidTransform(22).ID = "F[holder of Encoder-1:-:MH2530-6.35-10-1]";

%Translation Method - Cartesian
%Rotation Method - Arbitrary Axis
smiData.RigidTransform(23).translation = [0 0 8.9999999999999947];  % mm
smiData.RigidTransform(23).angle = 3.1415926535897931;  % rad
smiData.RigidTransform(23).axis = [1 0 0];
smiData.RigidTransform(23).ID = "B[cover of the bearing-1:-:holder of Encoder-1]";

%Translation Method - Cartesian
%Rotation Method - Arbitrary Axis
smiData.RigidTransform(24).translation = [-1.1147913445765798e-13 40.200000000000024 -4.1004084153097958e-14];  % mm
smiData.RigidTransform(24).angle = 2.0943951023931962;  % rad
smiData.RigidTransform(24).axis = [0.57735026918962606 -0.57735026918962495 0.57735026918962629];
smiData.RigidTransform(24).ID = "F[cover of the bearing-1:-:holder of Encoder-1]";

%Translation Method - Cartesian
%Rotation Method - Arbitrary Axis
smiData.RigidTransform(25).translation = [0 0 2.0000000000000018];  % mm
smiData.RigidTransform(25).angle = 0;  % rad
smiData.RigidTransform(25).axis = [0 0 0];
smiData.RigidTransform(25).ID = "B[Base cover-1:-:cover of the bearing-1]";

%Translation Method - Cartesian
%Rotation Method - Arbitrary Axis
smiData.RigidTransform(26).translation = [2.0261570199409107e-15 5.3290705182007514e-15 -5.0000000000000009];  % mm
smiData.RigidTransform(26).angle = 3.0866894851635984;  % rad
smiData.RigidTransform(26).axis = [-5.2061319478668392e-18 -5.5532074110579626e-17 1];
smiData.RigidTransform(26).ID = "F[Base cover-1:-:cover of the bearing-1]";
...
smiData.RigidTransform(27).ID = "B[cover of the bearing-1:-:MH2530-6.35-10-1]";

%Translation Method - Cartesian
%Rotation Method - Arbitrary Axis
smiData.RigidTransform(28).translation = [-2.6645352591003757e-15 -1.2079226507921703e-13 -49.600000000000023];  % mm
smiData.RigidTransform(28).angle = 2.1223652100323448e-15;  % rad
smiData.RigidTransform(28).axis = [-0.99741590728451612 -0.07184363504031259 7.6042206583763495e-17];
smiData.RigidTransform(28).ID = "F[cover of the bearing-1:-:MH2530-6.35-10-1]";

%Translation Method - Cartesian
%Rotation Method - Arbitrary Axis
smiData.RigidTransform(29).translation = [12.383012613042865 -48.404709819543314 45.908598744801381];  % mm
smiData.RigidTransform(29).angle = 1.5707963267948861;  % rad
...
smiData.PlanarJoint(1).ID = "[Base cover-1:-:NTN_6000  (Bearing 10x26x8)-8]";

%This joint has been chosen as a cut joint. Simscape Multibody treats cut joints as algebraic constraints to solve closed kinematic loops. The imported model does not use the state target data for this joint.
smiData.PlanarJoint(2).Rz.Pos = -3.8324198328967842;  % deg
smiData.PlanarJoint(2).Px.Pos = 0;  % mm
smiData.PlanarJoint(2).Py.Pos = 0;  % mm
smiData.PlanarJoint(2).ID = "[cross holder of the motor-1:-:MH2530-6.35-10-1]";
